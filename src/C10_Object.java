...
public class C10_Object {
	 ...
	 *  - Object 클래스에 정의되어 있는 toString() 메서드 원형은 해당 클래스의 이름과 메모리상 주소를 출력하게 되어있다
	 ...
	 *  - 같은 값을 넣었을때 예측하기 힘든 일정한 값이 나와야 한다
	...
	public static void main(String[] args) {
		...
		// 모든 객체는 toStirng()을 가지고 있을 수밖에 없으므로 이런 구현이 가능하다
		System.out.println(s1);
		
		// 해당 클래스만의 equals를 구현하여 '같음'을 구현할 수 있다
		System.out.println(s1.equals(s2));
		System.out.println(s1.equals(s3));
//		System.out.println(s1.equals("안녕하세요"));
