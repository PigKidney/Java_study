...
public class B14_Array {
	 ...
	 * -배열을 각 변수를 방 번호(index)를 통해 구분한다
	 * -배열의 인덱스는 0번부터 길이 -1번 까지 있다.
	 * -배열은 변수와는 다르게 각 방의 모든 값이 초기화 되어있다
...
//		System.out.println(avg);
		...
		// (빨간줄이 안나온다 ArrayIndexOutOfBoundsException 발생)
//		numbers[1000] = 777;
		...
		// ".length() : 문자열의 길이를 알 때는 괄호를 붙였다.
		String[] fruits = {"apple","banana","orange","kiwi","watermelon","grape"};
