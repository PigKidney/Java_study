...
public class D12_Calendar {
	/*
	 	...
	 	- 추상 클래스이기 때문에 생성자를 사용할 수 없고 getInstance()라는 스태틱 메서드로
	 	  현재 시간의 인스턴스를 받아올 수 있다
	...
	public static void main(String[] args) {
		...
		// : 캘린더 인스턴스에 시간 변경하기, 다른 필드들도 알맞게 수정된다
		now.set(Calendar.HOUR, 5);
		
		// cal.add(fieldNumber, value) : 캘린더 인스턴스 시간 추가히기
		...
		System.out.println("이번주의 며칠인가 : " +now.get(Calendar.DAY_OF_WEEK));
