...
public class C11_AccessModifier extends myobj.C11_ModifierTest {
	...
	public static void main(String[] args) {
		...
		//같은 패키지의 다른 클래스에 접근하는 경우(C11_ModifierTest)
		// public, protected, default 까지 접근이 가능하다
		...
		System.out.println("defualt static field : "+ C11_ModifierTest.si3);
...
//		C11_ModifierTest.smethod4();
		...
		System.out.println("defualt instance field : "+ instance.i3);
