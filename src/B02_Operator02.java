	...
	public static void main(String[] args) {
		/*
		  	# 비교 연산자
		  	 ...
		  	 - 두 값을 비교하는 연산
		  	 - 비교 연산의 결과는 항상 참(true) 또는 거직(false)이다.
		...
		// 비교 연산은 우선 순위가 낮다
		// ()가 없더라도 산술 연산을 먼저하고 비교 연산을 진행한다.
		System.out.println(a+5>b*10);
		
		// a를 2로 나누었을때 나머지가 o이면 true  (a에 짝수가 들어있으면 true)
		...
		// 논리 연사자는 비교 연산자보다 우선 순위가 낮기 때문에 
		// () 없이도 비교 연산을 먼저 수행한다.
		...
		// a가 3보다 작거나 같을 때 true -> a가 3보다 크지 않을 때 true
