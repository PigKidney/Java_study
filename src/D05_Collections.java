...
public class D05_Collections {
	...
	public static void main(String[] args) {
		...
		// Arrays.binarySearch(arr, value) : 원하는 값의 인덱스를 찾아 반환한다
		// -> 정렬 후에만 작동한다(이진탐색)
		...
		// 배열 크기 비교시 가장 앞에 있는 값이 우선순위가 높다
		// 왼쪽배열이 더 크면 1, 오른쪽 배열이 더 크면 -1, 두 배열이 완전히 같으면 0
		...
		System.out.println("0가 나온 횟수 : "+ zeroCount);
