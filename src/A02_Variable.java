	...
	public static void main(String[] args) {
		...
		/*
		  	...
		  	# 대입 연산 (=)
		  	 ...
		  	 - 프로그래밍 언어에서의 =의 의미 : 왼쪽에 있는 변수에 오른쪽에 있는 값을 넣어라(대입)
		...
		// 초기화가 되지 않은 변수는 사용할 수 없다 => 값을 한번도 넣은적 없는 변수는 사용할 수 없다.
		...
		// 		System.out.println("사과는 총"+(apple=3)+"개 입니다."); ->도 가능
		...
		System.out.println(snack4+" "+e+"개 있습니다.");
	}
}
