...
public class A06_Print {
    /*
		...
		# 콘솔에 출력하기 위한 함수들
		  ...
		  * 서식 문자의 종류
			...
			%X : 해당 자리에 정수값을 16진수(대문자)로 출력 (hexa)
			%f : 실수
			%s : 문자열
			%c : 문자
			%% : 그냥 %를 출력하고 싶을때 사용 (서식 문자의 Escape)
	...
	public static void main(String[] args) {
		...
		System.out.println(year+"년 "+month+"월 "+date+"일 "+ ampm + " " + hour+":"+minute+":"+second);
		...
		System.out.printf("보유금액 : %-10d원\n", money);
		System.out.printf("보유금액 : %+-8d원\n", money);
		
		double dollar = 10.15;
		
		System.out.printf("remains : %08.2f$\n", dollar);
