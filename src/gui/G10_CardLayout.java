...
public class G10_CardLayout {
	/*
	 * 다음 카드로 넘기듯이 컴포넌트를 넘기면서 보여줄 수 있는 레이아웃 ex : 설치 프로그램
	 * 
	 */
	...
	public static void main(String[] args) {
		...
		panel1NextBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// 카드 레이아웃을 조정하기 위해서는 해당 카드레이 아웃의 
				// 부모 컨테이너를 전달해줘야 한다
		...
		panel3Page1Btn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// show를 사용하기 위해서는
				// 카드레이웃에 컴포넌트를 추가할 때 이름 설정이 필요하다
		...
		JButton panel3Next1Btn = new JButton("Next");
		...
		panel3Next1Btn.setBounds(390, 200, 80, 50);
