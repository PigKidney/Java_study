...
public class E07_File {
	/*
	   ...
	   - 파일 스스템의 내용을 디렉토리 구조로 편리하게 볼 수 있는 프로그램이 탐색기이다
	...
	*/ 
	...
	public static void main(String[] args) {
		...
		File f3 = new File("/JavaFullStack_YGM"); // 현재 드라이브에 따라 달라지는 경로
		
		// 절대경로 - 뿌리부터 시작하는 경로
		//  	    현재 위치에 영향을 받지 않는다
		File f4 = new File("C:/JavaFullStack_YGM/JavaStudy/src/A00_Hello.java");
...
//		System.out.println("성공했나? "+ f6.mkdir()); 한번에 못만든다
		System.out.println("성공했나? "+ f6.mkdirs());
		
		// list() : 해당 디렉토리 내부의 파일 목록을 String[]로 꺼낸다
		File f7 = new File("C:/JavaFullStack_YGM/JavaStudy/src/");
