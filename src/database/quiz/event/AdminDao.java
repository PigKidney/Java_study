...
public class AdminDao {
	...
	public int updateQty(int pk, int qty) {
		try (Connection conn = DBConnector.getConnection();){
			String sql = "UPDATE eventprizes SET init_qty = ? FROM eventprizes WHERE prize_id = ?";
	...
	public int updateRate(int pk, double rate) {
		try (Connection conn = DBConnector.getConnection();){
			String sql = "UPDATE eventprizes SET prize_rate = ? FROM eventprizes WHERE prize_id = ?";
