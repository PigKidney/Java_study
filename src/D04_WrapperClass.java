...
public class D04_WrapperClass {
	...
	public static void main(String[] args) {
		...
		/*
		  ...
		  - 각 WarpperClass의 toString()은 해당 타입 값을 문자열로 변환하는 기능을 가지고 있다
		...
		String numStr5 = Integer.toHexString(num2); 	//toString(num2, 16);
		String numStr6 = Integer.toBinaryString(num2);	//toString(num2, 2);
		String numStr7 = Integer.toOctalString(num2);	//toString(num2, 8);
		...
		System.out.println("소대문자인가요? " + Character.isLowerCase('a'));
